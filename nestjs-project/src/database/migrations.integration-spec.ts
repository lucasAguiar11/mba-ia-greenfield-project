...
import { CreateVideos1783339439524 } from './migrations/1783339439524-CreateVideos';
...
describe('Database migrations (integration)', () => {
  ...
  beforeAll(async () => {
    ...
    // Sequential, children-before-parents — concurrent CASCADE drops across
    // FK-linked tables (videos→channels, refresh_tokens/verification_tokens→users,
    // channels→users) race for the same AccessExclusiveLock and can deadlock.
    const DROP_ORDER = [
      'videos',
      'refresh_tokens',
      'verification_tokens',
